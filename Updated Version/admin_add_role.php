...
body {
    ...
    background: #f5eee9; /* Gradient from white to light beige */
    color: black; /* Dark Coffee text */
    margin: 0;
    padding: 20px;
}
...
/* Form Button Styles */
form button {
    background-color: #c2a68d; /* Medium Coffee */
...
form button:hover {
    background-color: #ad947d; /* Darker Coffee on hover */
}
