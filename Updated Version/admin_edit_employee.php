...
button {
    padding: 8px 15px; /* Decreased padding for a smaller button */
    background-color: #c2a68d; /* Base coffee color */
...
a {
    ...
    padding: 8px 15px; /* Match the button padding */
    background-color: #c2a68d; /* Same color as buttons */
    color: #fff; /* White text */
    border-radius: 5px; /* Rounded corners */
...
/* Link Hover Effect */
a:hover {
    background-color: #b79b7e; /* Slightly darker on hover */
}
