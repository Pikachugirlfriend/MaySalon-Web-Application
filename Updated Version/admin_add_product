...
<body>
    ...
    <button class="exit-button" onclick="window.location.href='admin.php?page=products'">Exit to Admin</button>
</body>
</html>
...
body {
    ...
    background-color: #f5eee9; /* Dark Coffee Brown */
    color: black; /* Beige for contrast */
    margin: 0;
    padding: 20px;
}
...
form {
    background-color: white; /* Light Cream with transparency */
    border-radius: 10px;
    padding: 20px;
...
form textarea {
    ...
    border-radius: 5px;
    background-color: whitesmoke; /* Light Coffee Cream */
