...
<head>
    ...
    <style>
        ...
        .day {
            ...
            height: 150px; /* Increased height for larger cells */
            position: relative;
        ...
        /* Button Styling */
        .btn-cancel {
            background-color: #ff4c4c; /* Red for Cancel */
            color: white;
            padding: 10px 20px;
            border: none;
            border-radius: 5px;
        ...
        .btn-cancel:hover {
            background-color: #d94444; /* Darker red on hover */
        }
        ...
        * {
        ...
        body {
            background: #f5eee9; /* Light cream to coffee beige gradient */
            color: black; 
            line-height: 1.6;
            padding: 20px;
        }
        ...
        @media (max-width: 480px) {
            .day {
                width: calc(100% / 2); /* Show two days per row on small screens */
                height: 100px;
            }

            .week-header div {
                width: calc(100% / 2); /* Two day headers per row */
            }
        }
                    ...
                    <td>
                        <?php if ($row['Status'] != 'Cancelled' && $row['Status'] != 'Completed'): ?>
                            <form method="post" action="" onsubmit="return confirm('Are you sure you want to change the status?');">
                                ...
                                <input type="submit" name="action" value="cancel" class="btn-cancel" onclick="return confirm('Are you sure you want to cancel this appointment?');">
                                <input type="submit" name="action" value="complete" class="btn-complete" onclick="return confirm('Are you sure you want to mark this appointment as completed?');">
                            </form>
                        <?php endif; ?>
                    </td>
                </tr>
